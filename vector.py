...
class Vector(object):
    ...
    def cross_multiply(self, v):
        ...
        # a_2 * b_3 - b_2 * a_3
        cross_x = (self.coords[1] * v.coords[2]) - (v.coords[1] * self.coords[2])
        # a_3 * b_1 - b_3 * a_1
        cross_y = (self.coords[2] * v.coords[0]) - (v.coords[2] * self.coords[0])
        # a_1 * b_2 - b_1 * a_2
        cross_z = (self.coords[0] * v.coords[1]) - (v.coords[0] * self.coords[1])
